...
namespace JakeDrinkStore.DataAccess.Migrations
{
    ...
    [Migration("20230223104753_addOrderHeadAndDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JakeDrinkStore.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JakeDrinkStore.Models.OrderDetails", b =>
                {
                    b.HasOne("JakeDrinkStore.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("JakeDrinkStore.Models.OrderHeader", b =>
                {
                    b.HasOne("JakeDrinkStore.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("JakeDrinkStore.Models.ProductTag", b =>
                {
                    ...
                    b.HasOne("JakeDrinkStore.Models.ShoppingCart", null)
                        .WithMany("ProductTag")
            ...
            modelBuilder.Entity("JakeDrinkStore.Models.ApplicationUser", b =>
                {
                    b.HasOne("JakeDrinkStore.Models.Company", "Company")
                        .WithMany()
